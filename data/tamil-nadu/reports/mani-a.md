...
Mani A shows moderate transparency with a score of 57.2/100. Minor criminal cases on record. High parliament attendance. Data confidence is low — scores should be interpreted with caution.

---

Has 1 criminal case(s) (0 serious), 1 pending, 0 conviction(s). Parliament attendance: 85.0%. Questions asked: 20. Debates participated: 3. Low confidence data: Assets, MPLADS. 2 warning(s) noted.
...
Mani A, Member of Parliament (Lok Sabha), Dharmapuri, Tamil Nadu —
...
for the constituency of Dharmapuri represented by Mani A (Lok Sabha).
