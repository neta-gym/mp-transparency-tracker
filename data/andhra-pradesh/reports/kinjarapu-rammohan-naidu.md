# Kinjarapu Rammohan Naidu — Transparency Report
...
Kinjarapu Rammohan Naidu has a below-average transparency score of 46.0/100, indicating significant room for improvement. Significant criminal cases are a concern. Data confidence is low — scores should be interpreted with caution.

---

Has 4 criminal case(s) (0 serious), 4 pending, 0 conviction(s). Low confidence data: Assets, MPLADS, Parliament activity. 3 warning(s) noted.
...
Kinjarapu Rammohan Naidu, Member of Parliament (Lok Sabha), Srikakulam, Andhra Pradesh —
...
for the constituency of Srikakulam represented by Kinjarapu Rammohan Naidu (Lok Sabha).
