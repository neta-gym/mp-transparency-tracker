# Deepender Singh Hooda — Transparency Report
...
Deepender Singh Hooda shows moderate transparency with a score of 60.0/100. No criminal cases declared. High parliament attendance. Data confidence is low — scores should be interpreted with caution.

---

No criminal cases declared. Parliament attendance: 90.0%. Questions asked: 8. Debates participated: 8. Low confidence data: Assets, MPLADS. 2 warning(s) noted.
...
Deepender Singh Hooda, Member of Parliament (Lok Sabha), Rohtak, Haryana —
...
for the constituency of Rohtak represented by Deepender Singh Hooda (Lok Sabha).
