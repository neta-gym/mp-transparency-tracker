# Jai Parkash — Transparency Report
...
Jai Parkash shows moderate transparency with a score of 56.5/100. No criminal cases declared. High parliament attendance. Limited participation in parliamentary proceedings. Data confidence is low — scores should be interpreted with caution.

---

No criminal cases declared. Parliament attendance: 100.0%. Low confidence data: Assets, MPLADS. 2 warning(s) noted.
...
Jai Parkash, Member of Parliament (Lok Sabha), Hisar, Haryana —
...
for the constituency of Hisar represented by Jai Parkash (Lok Sabha).
