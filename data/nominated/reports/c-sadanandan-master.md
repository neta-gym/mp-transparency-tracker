# C. Sadanandan Master — Transparency Report
...
No criminal cases declared. Parliament attendance: 76.0%. Debates participated: 5. Low confidence data: Criminal record, Assets, MPLADS. 3 warning(s) noted.
...
C. Sadanandan Master, Member of Parliament (Rajya Sabha), Rajya Sabha (Nominated), Nominated —
...
for the constituency of Rajya Sabha (Nominated) represented by C. Sadanandan Master (Rajya Sabha).
