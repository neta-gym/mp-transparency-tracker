# Mahesh Kashyap — Transparency Report
...
Mahesh Kashyap shows moderate transparency with a score of 62.5/100. No criminal cases declared. Low MPLADS fund utilization needs attention. High parliament attendance.
...
Mahesh Kashyap, Member of Parliament (Lok Sabha), Bastar, Chhattisgarh —
...
for the constituency of Bastar represented by Mahesh Kashyap (Lok Sabha).
...
[Note: As per publicly available data, the following figures have been reported for Mahesh Kashyap's MPLADS account: Released: Rs 15, Expended: Rs 5, Utilization: 36.7%. This RTI seeks to verify and supplement this data.]
