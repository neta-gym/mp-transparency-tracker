# Tatkare Sunil Dattatrey — Transparency Report
...
Tatkare Sunil Dattatrey shows moderate transparency with a score of 57.0/100. No criminal cases declared. Data confidence is low — scores should be interpreted with caution.

---

No criminal cases declared. Parliament attendance: 70.0%. Questions asked: 25. Debates participated: 3. Low confidence data: Assets, MPLADS. 2 warning(s) noted.
...
Tatkare Sunil Dattatrey, Member of Parliament (Lok Sabha), Raigad, Maharashtra —
...
for the constituency of Raigad represented by Tatkare Sunil Dattatrey (Lok Sabha).
