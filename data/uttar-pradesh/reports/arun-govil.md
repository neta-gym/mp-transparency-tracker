# Arun Govil — Transparency Report
...
Arun Govil shows moderate transparency with a score of 67.2/100. No criminal cases declared. Low MPLADS fund utilization needs attention. High parliament attendance. Active in questions and debates.
...
Arun Govil, Member of Parliament (Lok Sabha), Meerut, Uttar Pradesh —
...
for the constituency of Meerut represented by Arun Govil (Lok Sabha).
...
[Note: As per publicly available data, the following figures have been reported for Arun Govil's MPLADS account: Released: Rs 15, Expended: Rs 6, Utilization: 39.7%. This RTI seeks to verify and supplement this data.]
