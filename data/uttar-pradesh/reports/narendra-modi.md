# Narendra Modi — Transparency Report
...
Narendra Modi shows moderate transparency with a score of 57.4/100. No criminal cases declared. Low MPLADS fund utilization needs attention.
...
Narendra Modi, Member of Parliament (Lok Sabha), Varanasi, Uttar Pradesh —
...
for the constituency of Varanasi represented by Narendra Modi (Lok Sabha).
...
[Note: As per publicly available data, the following figures have been reported for Narendra Modi's MPLADS account: Released: Rs 16, Expended: Rs 6, Utilization: 34.4%. This RTI seeks to verify and supplement this data.]
