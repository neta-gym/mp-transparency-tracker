# Vinod Kumar Bind — Transparency Report
...
Vinod Kumar Bind shows moderate transparency with a score of 63.1/100. No criminal cases declared. Low MPLADS fund utilization needs attention. Active in questions and debates.
...
Vinod Kumar Bind, Member of Parliament (Lok Sabha), Bhadohi, Uttar Pradesh —
...
for the constituency of Bhadohi represented by Vinod Kumar Bind (Lok Sabha).
...
[Note: As per publicly available data, the following figures have been reported for Vinod Kumar Bind's MPLADS account: Released: Rs 15, Expended: Rs 6, Utilization: 39.8%. This RTI seeks to verify and supplement this data.]
