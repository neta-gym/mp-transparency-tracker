# Devendra Singh Alias Bhole Singh — Transparency Report
...
Has 13 criminal case(s) (3 serious), 13 pending, 0 conviction(s). Declared assets: Rs 47,828,524. MPLADS utilization: 30.7%. Parliament attendance: 50.0%. Questions asked: 10. Debates participated: 3.
...
Devendra Singh Alias Bhole Singh, Member of Parliament (Lok Sabha), Akbarpur, Uttar Pradesh —
...
for the constituency of Akbarpur represented by Devendra Singh Alias Bhole Singh (Lok Sabha).
...
[Note: As per publicly available data, the following figures have been reported for Devendra Singh Alias Bhole Singh's MPLADS account: Released: Rs 15, Expended: Rs 5, Utilization: 30.7%. This RTI seeks to verify and supplement this data.]
