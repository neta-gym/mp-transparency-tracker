# Pushpendra Saroj — Transparency Report
...
Pushpendra Saroj has a below-average transparency score of 48.5/100, indicating significant room for improvement. No criminal cases declared. High parliament attendance. Data confidence is low — scores should be interpreted with caution.

---

No criminal cases declared. Parliament attendance: 90.0%. Questions asked: 1. Debates participated: 8. Low confidence data: Criminal record, Assets, MPLADS. 3 warning(s) noted.
...
Pushpendra Saroj, Member of Parliament (Lok Sabha), Kaushambi, Uttar Pradesh —
...
for the constituency of Kaushambi represented by Pushpendra Saroj (Lok Sabha).
