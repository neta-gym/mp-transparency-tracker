# Kamlesh Paswan — Transparency Report
...
Kamlesh Paswan has a below-average transparency score of 35.5/100, indicating significant room for improvement. Significant criminal cases are a concern. Data confidence is low — scores should be interpreted with caution.

---

Has 9 criminal case(s) (4 serious), 7 pending, 2 conviction(s). Low confidence data: Assets, MPLADS, Parliament activity. 3 warning(s) noted.
...
Kamlesh Paswan, Member of Parliament (Lok Sabha), Bansgaon, Uttar Pradesh —
...
for the constituency of Bansgaon represented by Kamlesh Paswan (Lok Sabha).
