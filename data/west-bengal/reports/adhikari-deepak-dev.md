# Adhikari Deepak Dev — Transparency Report
...
Adhikari Deepak Dev has a below-average transparency score of 45.5/100, indicating significant room for improvement. No criminal cases declared. Low parliament attendance is notable. Data confidence is low — scores should be interpreted with caution.

---

No criminal cases declared. Parliament attendance: 0.0%. Questions asked: 31. Low confidence data: Assets, MPLADS. 2 warning(s) noted.
...
Adhikari Deepak Dev, Member of Parliament (Lok Sabha), Ghatal, West Bengal —
...
for the constituency of Ghatal represented by Adhikari Deepak Dev (Lok Sabha).
