...
Kakoli Ghosh Dastidar has a below-average transparency score of 37.1/100, indicating significant room for improvement. Significant criminal cases are a concern. Low MPLADS fund utilization needs attention. Limited participation in parliamentary proceedings. Data confidence is low — scores should be interpreted with caution.

---

No criminal cases declared. MPLADS utilization: 41.1%. Parliament attendance: 40.0%. Debates participated: 1. Low confidence data: Criminal record, Assets. 2 warning(s) noted.
