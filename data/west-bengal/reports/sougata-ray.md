# Sougata Ray — Transparency Report
...
Sougata Ray shows moderate transparency with a score of 60.5/100. Minor criminal cases on record. High parliament attendance. Active in questions and debates. Data confidence is low — scores should be interpreted with caution.

---

Has 1 criminal case(s) (1 serious), 1 pending, 0 conviction(s). Parliament attendance: 100.0%. Questions asked: 48. Debates participated: 20. Low confidence data: Assets, MPLADS. 2 warning(s) noted.
...
Sougata Ray, Member of Parliament (Lok Sabha), Dum Dum, West Bengal —
...
for the constituency of Dum Dum represented by Sougata Ray (Lok Sabha).
