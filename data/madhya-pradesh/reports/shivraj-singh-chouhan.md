# Shivraj Singh Chouhan — Transparency Report
...
Shivraj Singh Chouhan shows moderate transparency with a score of 52.0/100. Minor criminal cases on record. Data confidence is low — scores should be interpreted with caution.

---

Has 1 criminal case(s) (0 serious), 1 pending, 0 conviction(s). Low confidence data: Assets, MPLADS, Parliament activity. 3 warning(s) noted.
...
Shivraj Singh Chouhan, Member of Parliament (Lok Sabha), Vidisha, Madhya Pradesh —
...
for the constituency of Vidisha represented by Shivraj Singh Chouhan (Lok Sabha).
