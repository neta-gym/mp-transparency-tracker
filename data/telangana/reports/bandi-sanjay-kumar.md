# Bandi Sanjay Kumar — Transparency Report
...
Bandi Sanjay Kumar has a below-average transparency score of 34.0/100, indicating significant room for improvement. Significant criminal cases are a concern. Data confidence is low — scores should be interpreted with caution.

---

Has 42 criminal case(s) (1 serious), 42 pending, 0 conviction(s). Low confidence data: Assets, MPLADS, Parliament activity. 3 warning(s) noted.
...
Bandi Sanjay Kumar, Member of Parliament (Lok Sabha), Karimnagar, Telangana —
...
for the constituency of Karimnagar represented by Bandi Sanjay Kumar (Lok Sabha).
