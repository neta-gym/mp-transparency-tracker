# B Y Raghavendra — Transparency Report
...
B Y Raghavendra shows moderate transparency with a score of 60.0/100. Minor criminal cases on record. High parliament attendance.

---

Has 1 criminal case(s) (0 serious), 1 pending, 0 conviction(s). Parliament attendance: 80.0%. Questions asked: 21. Debates participated: 2. Low confidence data: Assets, MPLADS. 2 warning(s) noted.
...
B Y Raghavendra, Member of Parliament (Lok Sabha), Shimoga, Karnataka —
...
for the constituency of Shimoga represented by B Y Raghavendra (Lok Sabha).
