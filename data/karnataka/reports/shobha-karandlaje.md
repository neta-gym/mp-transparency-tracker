# Shobha Karandlaje — Transparency Report
...
Shobha Karandlaje has a below-average transparency score of 44.0/100, indicating significant room for improvement. Significant criminal cases are a concern. Data confidence is low — scores should be interpreted with caution.

---

Has 5 criminal case(s) (0 serious), 5 pending, 0 conviction(s). Low confidence data: Assets, MPLADS, Parliament activity. 3 warning(s) noted.
...
Shobha Karandlaje, Member of Parliament (Lok Sabha), Bangalore North, Karnataka —
...
for the constituency of Bangalore North represented by Shobha Karandlaje (Lok Sabha).
