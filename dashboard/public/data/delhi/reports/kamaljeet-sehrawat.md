# Kamaljeet Sehrawat — Transparency Report
...
|----------|--------|----------|--------|
| Twitter | [@KamaljeetBJP](https://x.com/KamaljeetBJP) | Yes | Yes |
...
No criminal cases declared. Declared assets: Rs 147,436,650. MPLADS utilization: 6.3%. Parliament attendance: 95.0%. Questions asked: 65. Debates participated: 6. 1 warning(s) noted.
...
Kamaljeet Sehrawat, Member of Parliament (Lok Sabha), West Delhi, Delhi —
...
for the constituency of West Delhi represented by Kamaljeet Sehrawat (Lok Sabha).
...
[Note: As per publicly available data, the following figures have been reported for Kamaljeet Sehrawat's MPLADS account: Released: Rs 15, Expended: Rs 1, Utilization: 6.3%. This RTI seeks to verify and supplement this data.]
