# Upendra Kushwaha — Transparency Report
...
Has 7 criminal case(s) (1 serious), 7 pending, 0 conviction(s). Low confidence data: Assets, Parliament activity. 2 warning(s) noted.
...
Upendra Kushwaha, Member of Parliament (Rajya Sabha), Rajya Sabha (Bihar), Bihar —
...
for the constituency of Rajya Sabha (Bihar) represented by Upendra Kushwaha (Rajya Sabha).
