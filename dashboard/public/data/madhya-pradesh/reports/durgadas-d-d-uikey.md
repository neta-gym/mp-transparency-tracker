# Durgadas D D Uikey — Transparency Report
...
Durgadas D D Uikey shows moderate transparency with a score of 60.1/100. No criminal cases declared.
...
Durgadas D D Uikey, Member of Parliament (Lok Sabha), Betul, Madhya Pradesh —
...
for the constituency of Betul represented by Durgadas D D Uikey (Lok Sabha).
...
[Note: As per publicly available data, the following figures have been reported for Durgadas D D Uikey's MPLADS account: Released: Rs 15, Expended: Rs 8, Utilization: 54.6%. This RTI seeks to verify and supplement this data.]
