# Aditya Yadav — Transparency Report
...
Aditya Yadav shows moderate transparency with a score of 69.2/100. No criminal cases declared. Low MPLADS fund utilization needs attention. High parliament attendance.
...
Aditya Yadav, Member of Parliament (Lok Sabha), Badaun, Uttar Pradesh —
...
for the constituency of Badaun represented by Aditya Yadav (Lok Sabha).
...
[Note: As per publicly available data, the following figures have been reported for Aditya Yadav's MPLADS account: Released: Rs 15, Expended: Rs 7, Utilization: 45.8%. This RTI seeks to verify and supplement this data.]
