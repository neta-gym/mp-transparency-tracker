...
Anurag Sharma shows moderate transparency with a score of 69.9/100. No criminal cases declared. Low MPLADS fund utilization needs attention. High parliament attendance. Active in questions and debates.
...
Anurag Sharma, Member of Parliament (Lok Sabha), Jhansi, Uttar Pradesh —
...
for the constituency of Jhansi represented by Anurag Sharma (Lok Sabha).
...
[Note: As per publicly available data, the following figures have been reported for Anurag Sharma's MPLADS account: Released: Rs 15, Expended: Rs 6, Utilization: 41.6%. This RTI seeks to verify and supplement this data.]
