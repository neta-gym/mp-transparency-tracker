# Ramesh Awasthi — Transparency Report
...
Ramesh Awasthi shows moderate transparency with a score of 66.0/100. No criminal cases declared. Low MPLADS fund utilization needs attention. High parliament attendance.
...
Ramesh Awasthi, Member of Parliament (Lok Sabha), Kanpur, Uttar Pradesh —
...
for the constituency of Kanpur represented by Ramesh Awasthi (Lok Sabha).
...
[Note: As per publicly available data, the following figures have been reported for Ramesh Awasthi's MPLADS account: Released: Rs 15, Expended: Rs 5, Utilization: 34.8%. This RTI seeks to verify and supplement this data.]
