# Priya Saroj — Transparency Report
...
Priya Saroj shows moderate transparency with a score of 55.9/100. Minor criminal cases on record. Low MPLADS fund utilization needs attention. High parliament attendance. Limited participation in parliamentary proceedings.
...
Machhlishahr District,
Uttar Pradesh

Subject: Information regarding MPLADS Fund utilization under the constituency of
Priya Saroj, Member of Parliament (Lok Sabha), Machhlishahr, Uttar Pradesh —
...
for the constituency of Machhlishahr represented by Priya Saroj (Lok Sabha).
...
[Note: As per publicly available data, the following figures have been reported for Priya Saroj's MPLADS account: Released: Rs 15, Expended: Rs 5, Utilization: 36.6%. This RTI seeks to verify and supplement this data.]
