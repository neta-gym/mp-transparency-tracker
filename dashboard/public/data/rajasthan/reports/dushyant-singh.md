# Dushyant Singh — Transparency Report
...
Dushyant Singh has a below-average transparency score of 47.5/100, indicating significant room for improvement. Significant criminal cases are a concern. Low MPLADS fund utilization needs attention. High parliament attendance. Active in questions and debates.

---

No criminal cases declared. Declared assets: Rs 389,308,540. MPLADS utilization: 3.4%. Parliament attendance: 100.0%. Questions asked: 52. Debates participated: 9. Low confidence data: Criminal record. 2 warning(s) noted.
...
Jhalawar-Baran District,
Rajasthan

Subject: Information regarding MPLADS Fund utilization under the constituency of
Dushyant Singh, Member of Parliament (Lok Sabha), Jhalawar-Baran, Rajasthan —
...
for the constituency of Jhalawar-Baran represented by Dushyant Singh (Lok Sabha).
...
[Note: As per publicly available data, the following figures have been reported for Dushyant Singh's MPLADS account: Released: Rs 15, Expended: Rs 0, Utilization: 3.4%. This RTI seeks to verify and supplement this data.]
