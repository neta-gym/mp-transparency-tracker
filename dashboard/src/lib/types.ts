...
export const SCORE_COMPONENTS: ScoreComponent[] = [
  { key: "mplads_score", label: "MPLADS", weight: 0.2353 },
  { key: "asset_score", label: "Assets", weight: 0.1765 },
  { key: "criminal_score", label: "Criminal", weight: 0.2353 },
  { key: "attendance_score", label: "Attendance", weight: 0.1765 },
  { key: "participation_score", label: "Participation", weight: 0.1176 },
  { key: "committee_score", label: "Committees", weight: 0 },
  { key: "accessibility_score", label: "Accessibility", weight: 0.0588 },
  { key: "legislative_score", label: "Legislative", weight: 0 },
];
